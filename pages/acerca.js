  ...
  return (
    <div className="container text-center">
      ...
      <p className="text-lg mb-4 text-gray-700">
        ...
        automatización industrial, IoT, ingeniería aeroespacial y escalar cerros
        de más de 5.000 metros. Siempre buscando aprender y experimentar en
        tecnología y aventuras.
      </p>
      <p className="text-lg mb-6 text-gray-700">
        Si querés ver algunos de mis proyectos o conectarte conmigo:
      </p>
      <div className="flex justify-center gap-8 text-5xl text-gray-800">
        <a
